...
$(shell mkdir -p $(TARGET_OUT_KEYLAYOUT); \
    cp -pf device/infinix/x510/keylayout/Generic.kl $(TARGET_OUT_KEYLAYOUT))

# copy permissions overrides
$(shell mkdir -p $(TARGET_OUT_ETC)/permissions; \
    cp -pf device/infinix/x510/configs/android.hardware.camera.xml $(TARGET_OUT_ETC)/permissions)
